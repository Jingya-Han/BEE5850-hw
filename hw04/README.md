...
This is the repository for Homework 4 for [BEE 4850](https://viveks.me/simulation-data-analysis), taught at [Cornell University](https://cornell.edu) in Spring 2024 by [Vivek Srikrishnan](https://viveks.me).

If enrolled in the class, a PDF of the completed assignment, **with all cells evaluated if a notebook**, should be submitted to Gradescope *no later* than Friday, May 3, 2024, at 9:00pm. The assignment will be penalized 50% if it is submitted up to 24 hours late.
...
2. Opening the notebook will depend on what you decided to do in the previous step. 
  ...
  - If you want to use `IJulia.jl`, open a Julia prompt. You can do this by:
    ...
    - Navigating to your `BEE4850/hw/hw04` folder and typing `julia` to open the prompt.Then:
